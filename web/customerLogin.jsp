<%-- 
    ...
    Created on : 25 May 2023, 11:00:56 pm
    Author     : ariff
--%>
...
<html lang="en">
    ...
    <body>
        <div>
            <form action="customerLoginServlet" method="post" class="container">
                <h1 class="center">Customer Login</h1>
                ...
                <div class="center">
                    <a href="custSignUp.jsp">Don't have an account?</a>
                </div>
                <div class="center">
