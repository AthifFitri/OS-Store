<%-- 
    ...
    Created on : 15 Jun 2023, 10:35:59 pm
    Author     : ariff
--%>
                    ...
                    <form>
                        <table border="0">
                            <tbody>
                                <tr>
                                    <td>First Name :</td>
                                    <td><input type="text" name="firstName" readonly="readonly" value="<%=firstName%>" ></td>
                                </tr>
                                <tr>
                                    <td>Last Name :</td>
                                    <td><input type="text" name="lastName" readonly="readonly" value="<%=lastName%>"></td>
                                </tr>
                                <tr>
                                    <td>Phone Number :</td>
                                    <td><input type="text" name="phone" readonly="readonly" value="<%=phone%>"></td>
                                </tr>
                                <tr>
                                    <td class="button" colspan="2" align="center">
                                        <a href="customerEditProfile.jsp?CustID=<%=customerID%>" type="button" class="btn">Edit</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
